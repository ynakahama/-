...
def load_carla_env(
  ...
  port=2000,
  town='Town02',
  task_mode='general_route_random_quadrants', #'random',
...
def train_eval(
  ...
  with tf.summary.record_if(
    ...
    #print("DEBUG: env")
    #print(py_env.task_mode)
    #print(eval_py_env.task_mode)
    #print(tf_env.task_mode)
    #print(eval_tf_env.task_mode)
    ...
    for iteration in range(num_iterations):
      ...
      if global_step.numpy() % 500 == 0:
        ...
        if global_step.numpy() % 2000 == 0:
          print("DEBUG: task_mode is changed to first")
          py_env.task_mode = 'first_quadrant'
          eval_py_env.task_mode = 'first_quadrant'
          tf_env = tf_py_environment.TFPyEnvironment(py_env)
          eval_tf_env = tf_py_environment.TFPyEnvironment(eval_py_env)
        if global_step.numpy() % 2000 == 500:
          print("DEBUG: task_mode is changed to second")
          py_env.task_mode = 'second_quadrant'
          eval_py_env.task_mode = 'second_quadrant'
          tf_env = tf_py_environment.TFPyEnvironment(py_env)
          eval_tf_env = tf_py_environment.TFPyEnvironment(eval_py_env)
        if global_step.numpy() % 2000 == 1000:
          print("DEBUG: task_mode is changed to third")
          py_env.task_mode = 'third_quadrant'
          eval_py_env.task_mode = 'third_quadrant'
          tf_env = tf_py_environment.TFPyEnvironment(py_env)
          eval_tf_env = tf_py_environment.TFPyEnvironment(eval_py_env)
        if global_step.numpy() % 2000 == 1500:
          print("DEBUG: task_mode is changed to fourth")
          py_env.task_mode = 'fourth_quadrant'
          eval_py_env.task_mode = 'fourth_quadrant'
          tf_env = tf_py_environment.TFPyEnvironment(py_env)
          eval_tf_env = tf_py_environment.TFPyEnvironment(eval_py_env)
      """        
